                        ...
                        <form action="./register.php" method="POST">
                            ...
                            <div class="form-element success">
                                ...
                                <div class="form-alert-input">
                                    <input type="text" placeholder="KArdash zakaria" name="firstname" id="firstname" />
                            ...
                            <div class="form-element success">
                                ...
                                <div class="form-alert-input">
                                    <input type="text" placeholder="KArdash " name="lastname" id="lastname" />
                                    <div class="form-alert-icon">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
                            ...
                            <div class="form-element error">
                                ...
                                <div class="form-alert-input">
                                    <input type="email" placeholder="KArdash@gmail.com" name="email" id="email" />
                                    <div class="form-alert-icon">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
                            ...
                            <div class="form-element">
                                ...
                                <div class="form-alert-input">
                                    <input type="password" placeholder="Type here..." name="confirm-password" id="confirm-password" />
